        ...
        <table class="table table-bordered">
            ...
            @foreach($equipmentlog as $row)
                <tr>
                    ...
                    <td>{{$row['time_in']}}</td>
                    <td>{{$row['time_out']}}</td>
                    <td><a href="{{action('EquipmentLogController@edit', $row['id'])}}" class="btn btn-warning">Edit</a></td>
                    <td>
                        <form method="post" class="delete_form" action="{{action('EquipmentLogController@destroy', $row['id'])}}">
                            {{csrf_field()}}
